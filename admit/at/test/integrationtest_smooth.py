...
class IntegTestSmoothAT(unittest.TestCase):

    def setUp(self):
        self.root = admit.utils.admit_root()
        self.inputFile  = self.root + "/admit/at/test/mom_integ_test_input.fits"
        self.admitdir   = self.root + "/admit/at/test/smooth_integ_test_input.admit"
...
suite = unittest.TestLoader().loadTestsFromTestCase(IntegTestSmoothAT)
